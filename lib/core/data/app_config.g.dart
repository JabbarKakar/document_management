...
void _appConfigSerialize(
  ...
  writer.writeBool(offsets[0], object.dummy);
}
...
AppConfig _appConfigDeserialize(
  ...
  object.dummy = reader.readBool(offsets[0]);
  object.id = id;
  return object;
}
...
extension AppConfigQueryFilter
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> dummyEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigQuerySortBy on QueryBuilder<AppConfig, AppConfig, QSortBy> {
  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> sortByDummy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dummy', Sort.asc);
    });
  }

  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> sortByDummyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dummy', Sort.desc);
    });
  }
}
...
extension AppConfigQuerySortThenBy
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByDummy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dummy', Sort.asc);
    });
  }

  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByDummyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dummy', Sort.desc);
    });
  }
...
extension AppConfigQueryWhereDistinct
  ...
  QueryBuilder<AppConfig, AppConfig, QDistinct> distinctByDummy() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dummy');
    });
  }
}
...
extension AppConfigQueryProperty
  ...
  QueryBuilder<AppConfig, bool, QQueryOperations> dummyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dummy');
    });
  }
}
